...
import message.system.repository.db.hibernateimpl.service.CacheDbServiceUserImpl;
import message.system.repository.db.hibernateimpl.service.DbServiceUserImpl;
...
@ComponentScan(basePackages = "message.system")
@EnableWebMvc
